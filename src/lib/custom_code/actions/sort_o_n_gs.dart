...
//teste
Future<List<DocumentReference>?> sortONGs(
  LatLng? localizacaoUsuario,
  List<UsuariosRecord>? ongs,
) async {
  if (ongs == null) return [];
  if (localizacaoUsuario == null)
    return ongs!.where((o) => o != null).map((o) => o!.reference).toList();

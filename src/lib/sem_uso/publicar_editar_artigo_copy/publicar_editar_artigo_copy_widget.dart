...
import 'publicar_editar_artigo_copy_model.dart';
export 'publicar_editar_artigo_copy_model.dart';

class PublicarEditarArtigoCopyWidget extends StatefulWidget {
  const PublicarEditarArtigoCopyWidget({
    super.key,
    String? titulo,
    String? resumo,
  ...
  static String routeName = 'Publicar_Editar_ArtigoCopy';
  static String routePath = '/publicarEditarArtigoCopy';

  @override
  State<PublicarEditarArtigoCopyWidget> createState() =>
      _PublicarEditarArtigoCopyWidgetState();
}

class _PublicarEditarArtigoCopyWidgetState
    extends State<PublicarEditarArtigoCopyWidget>
    with TickerProviderStateMixin {
  late PublicarEditarArtigoCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PublicarEditarArtigoCopyModel());

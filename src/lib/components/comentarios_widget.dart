...
/// Create a component for comments.
///
/// It should contain a space for a user to comment and a submit button when
/// the person has finished commenting and wants to submit.
///
/// It should also display comments made by other users with each user's name
/// and photo.
///
/// There should also be a button to delete each comment already made.
              ...
              children: [
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                await ComentariosRecord.createDoc(widget!.post!)
                ...
                StreamBuilder<List<ComentariosRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ComentariosRecord> columnComentariosRecordList =
                        snapshot.data!;

                    return Column(
                      mainAxisSize: MainAxisSize.min,
                      children: List.generate(
                          columnComentariosRecordList.length, (columnIndex) {
                        final columnComentariosRecord =
                            columnComentariosRecordList[columnIndex];
                        return Container(
                          width: 800.0,
                          decoration: BoxDecoration(
                            color: FlutterFlowTheme.of(context)
                          ...
                          child: Padding(
                            ...
                            child: StreamBuilder<UsuariosRecord>(
                              stream: UsuariosRecord.getDocument(
                                  columnComentariosRecord.criadorRef!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(

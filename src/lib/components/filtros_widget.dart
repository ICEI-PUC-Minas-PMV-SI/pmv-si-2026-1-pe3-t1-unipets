...
/// Create a component that includes a section for searching by typing (e.g.,
/// NGO name or animal name).
///
/// Additionally, it should have a dropdown menu where I can add options to
...
class FiltrosWidget extends StatefulWidget {
  ...
  final Future Function(String texto)? aoDigitar;
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: FlutterFlowTheme.of(context).cinzaClaro,
                        width: 1.0,
                      ),
                    ),
                    child: Padding(

import '/animais/gerenciar_animal/gerenciar_animal_widget.dart';
...
import 'detalhes_animais_model.dart';
export 'detalhes_animais_model.dart';
...
class DetalhesAnimaisWidget extends StatefulWidget {
  const DetalhesAnimaisWidget({
    super.key,
  ...
  @override
  State<DetalhesAnimaisWidget> createState() => _DetalhesAnimaisWidgetState();
}

class _DetalhesAnimaisWidgetState extends State<DetalhesAnimaisWidget> {
  late DetalhesAnimaisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesAnimaisModel());
                      ...
                      children: [
                        ...
                        Flexible(
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: StreamBuilder<List<VacinasRecord>>(
                                  stream: queryVacinasRecord(
                                    parent: widget!.animal,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                              ...
                              Expanded(
                                child: StreamBuilder<List<ExamesRecord>>(
                                  stream: queryExamesRecord(
                                    parent: widget!.animal,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                              ...
                              Expanded(
                                child: StreamBuilder<List<DoencasRecord>>(
                                  stream: queryDoencasRecord(
                                    parent: widget!.animal,
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          ...
                                          return Row(
                                            mainAxisSize: MainAxisSize.max,
                                            children: List.generate(
                                                doencas.length, (doencasIndex) {
                                              final doencasItem =
                                                  doencas[doencasIndex];
                                              return Padding(
                                                padding: EdgeInsets.all(6.0),
                                                child: Column(
                                                  mainAxisSize:
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (dialogContext) {
                                        return Dialog(
                                          ...
                                          child: GerenciarAnimalWidget(
                                            animal: containerAnimaisRecord
                                                .reference,
                                          ),
                                        );
                                      },
